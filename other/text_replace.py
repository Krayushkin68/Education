...
sentences = 'I like to play video games and to ride in cars. I also enjoy table tennis, basketball, and hockey. Additionally, when bored, I sometimes like to play football, though I rarely do that anymore.'.split('.')
